...
<div style={{ height: 650, width: 430 }} className="bg-white shadow-[0_8px_30px_rgb(0,0,0,0.12)] rounded-2xl px-8 py-8 flex flex-col justify-between">
      <div>
        ...
        <div className="px-8">
          ...
          <span>`&ldquo;`I specialize in application development using Swift and Kotlin, capable of crafting efficient and user-friendly iOS and Android apps.`&rdquo;`</span></div>
        </div>
      </div>
